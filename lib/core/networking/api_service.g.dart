...
class _ApiService implements ApiService {
  ...
  Future<ActivateAccountResponseModel> activateAccount(
    ActivateAccountRequestModel body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<ActivateAccountResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/activateAccount',
  ...
  Future<SendForgetPasswordResponseModel> sendForgetPasswordCode(
    SendForgetPasswordRequestModel body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<SendForgetPasswordResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<PlantResponse> getAllPlants(String token) async {
    ...
    final _options = _setStreamType<PlantResponse>(
  ...
  Future<AnimalResponse> getAllAnimals(String token) async {
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AnimalResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'animal',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AnimalResponse _value;
    try {
      _value = AnimalResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ReportResponseModel> report(String token, ReportRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<ReportResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<EmailCheckResponseModel> checkEmail(
    ...
    final _options = _setStreamType<EmailCheckResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/checkEmail',
