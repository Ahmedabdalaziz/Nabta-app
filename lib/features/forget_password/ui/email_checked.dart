...
class EmailChecked extends StatefulWidget {
  const EmailChecked({super.key});

  @override
  State<EmailChecked> createState() => _EmailCheckedState();
}

class _EmailCheckedState extends State<EmailChecked> {
  bool isLoading = false;

  void _onUpdatePasswordPressed() async {
    setState(() {
      isLoading = true;
    });
