...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _onControllerChanged() {
    setState(() {
      // Show initial message only if controller is empty and keyboard is not open
      _showInitialMessage =
  ...
  Widget build(BuildContext context) {
    ...
    // Update _showInitialMessage based on keyboard state and text content
            ...
            child: ChatInputField(
              ...
              onSendPressed: () {
                if (_controller.text.isNotEmpty) {
                  ...
                  setState(() {
                    _showInitialMessage =
                        false; // Hide initial message after sending
                  });
                }
              },
              onMicPressed: () {
